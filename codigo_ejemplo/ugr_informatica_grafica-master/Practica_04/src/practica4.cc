...
void change_projection() {
  ...
  glFrustum(-Window_width, Window_width, -Window_height * ratio,
            Window_height * ratio, Front_plane, Back_plane);
}
...
void normal_keys(unsigned char Tecla1, int x, int y) {
  switch (Tecla1) {
    ...
    case ',': {
      // Asignamos el model1 como nulo para poder saber que estamos en la
      // practica 4
      model1 = NULL;
...
int main(int argc, char **argv) {
  ...
  if (argc != 2) {
    ...
    cout << "Modos: 1: puntos | 2: alambre | 3: sólido | 4: ajedrez" << endl
         << endl;
