...
class Model {
 ...
 public:
  ...
  // pasamos los vertices de un modelo a otro (cargamos un ply y lo pasamos a
  // uno de revolucion)
  ...
  // Esta funcion procesa una letra en el modelo, sirve para extender el
  // procesado de teclas, de ahí que sea virtual
